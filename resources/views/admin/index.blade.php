...
<!-- //bootstrap-css -->
<!-- Custom CSS -->
<link href="{{asset('public/backend/css/show.css')}}" rel='stylesheet' type='text/css' />
...
<link rel="stylesheet" href="{{asset('public/backend/css/swiper.min.css')}}" type="text/css"/>
...
<script src="{{asset('public/backend/js/swiper.min.js')}}"></script>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{route('category.index')}}">Liệt kê danh mục sản phẩm</a></li>
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{route('brand.create')}}">Thêm hiệu sản phẩm</a></li>
                ...
                @hasrole(['admin'])
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                         <li><a href="{{route('user.create')}}">Thêm user</a></li>

				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{{URL::to('/trangchu')}}"><img src="images/logo.png" alt="" /></a>
						</div>
								...
								<div class="panel panel-default">
									...
									@foreach ($categories as $category)
										@if($category->status == 0 )
											<div class="panel panel-default">
												<div class="panel-heading">
														<h4 class="panel-title"><a href="{{route('category.show',['category' => $category->id])}}">{{$category->name}}</a></h4>
												</div>
											</div>
										@endif	
									@endforeach
							...
							<div class="brands-name">
									<ul class="nav nav-pills nav-stacked">
										@foreach ($brands as $brand)
											@if($brand->status == 0)
												<li><a href="{{route('brand.show',['brand' => $brand->id])}}"> <span class="pull-right">(4)</span>{{$brand->name}}</a></li>
											@endif	
										@endforeach
									</ul>
							</div>
